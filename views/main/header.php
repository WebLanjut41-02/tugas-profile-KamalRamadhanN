...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url()?>aset/vendors/lightbox/simpleLightbox.css">
  <link rel="stylesheet" href="<?php echo base_url()?>aset/vendors/nice-select/css/nice-select.css">
  <link rel="stylesheet" href="<?php echo base_url()?>aset/vendors/animate-css/animate.css">
  <!-- main css -->
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-sm-6 col-4 header-top-left">
            <a href="tel:+9530123654896">
              ...
              <span class="text">
                <span class="text">0895351128786</span>
              </span>
            </a>
